...
public class weatherAlarmReceiver extends WakefulBroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        if (ACTION_START_NOTIFICATION_SERVICE.equals(action)) {
            ...
            serviceIntent = weatherService.createIntentStartNotificationService(context);
        } else if (ACTION_DELETE_NOTIFICATION.equals(action)) {
            Log.i(getClass().getSimpleName(), "onReceive delete notification action, starting notification service to handle delete");
            serviceIntent = weatherService.createIntentDeleteNotification(context);
        }
